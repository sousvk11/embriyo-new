...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></script>
    ...
    <link href="{{ asset('assets/cssfile/digitized.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/cssfile/uploaded.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/cssfile/store.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/cssfile/uploadFileModal.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/cssfile/productModal.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/cssfile/digiModal.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/cssfile/payout.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('assets/cssfile/faqs.css') }}" rel="stylesheet" type="text/css" />
